...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 03 Oca 2024, 23:11:30
...
CREATE TABLE `pet_info` (
  ...
  `diseaseDetail` varchar(250) NOT NULL,
  `nextInfoDate` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(5, 'admin', 'fleaudie@gmail.com', 'Betül', 'Kansu', '$2y$10$S0q9zjWW6k2nlyaj93OVOuHFKV.bCAzYuCiAuhzlpZFfbgFdiiavK', 'admin', 1, 0);
