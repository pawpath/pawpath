                ...
                <div class="col-pet-bg">
                    <div class="col-pet-info">
                        ...
                        <div class="col-pet-info-text">
                            ...
                            <h2>Arwen</h2>
                            <ul>
                                <li><b>Irkı: </b><span>Kedi</span></li>
                                <li><b>Cinsi: </b><span>Van Kedisi</span></li>
                                <li><b>Cinsiyeti: </b><span>Dişi</span></li>
                                <li><b>Yaşı: </b><span>5</span></li>
                            </ul>
                            <div>
                    ...
                    <div class="col-pet-health">
                        ...
                        <div class="col-pet-allergy">
                            <div class="pet-allergy"><h3>Alerji Adı</h3></div>
                            <div class="pet-allergy"><h3>Alerji Adı</h3></div>
                            <div class="pet-allergy"><h3>Alerji Adı</h3></div>
                        </div>
                        <h2>Hastalıklar</h2>
